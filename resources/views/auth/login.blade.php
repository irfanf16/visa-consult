        ...
        <div class="col-12 align-self-center">
            <div class="row">
                <div class="col-lg-5 mx-auto">
                    <div class="card">
                        <div class="card-body p-0 auth-header-box mt-5 mb-5">
                            <div class="text-center p-3 mt-3 mb-3">
...
{{--                                <h4 class="mt-3 mb-1 fw-semibold text-white font-18">Lets Get Started Dastone</h4>--}}
                                <p class="mt-3 mb-1 text-muted  mb-0">Sign in to continue to Storak Group.</p>
                            </div>
                        </div>
...
{{--                                    </div>--}}
                        ...
                        <div class="card-body bg-light-alt text-center">
                            <span class="text-muted d-none d-sm-inline-block">StorakDigital © <script>
