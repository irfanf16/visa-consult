    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-parsley" action='{{ URL::to("/admin/blogs/$category->id") }}' method="POST" enctype="multipart/form-data"
                        novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-floating mb-3">
                          ...
                          {{--  image  --}}
                          <img src="{{ asset('storage/blogs/'. $category->image) }}" width="30%" alt="Category Image">
