    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-parsley" action="{{ URL::to('/admin/services') }}" method="POST" novalidate enctype="multipart/form-data">
                        @csrf
                        ...
                        {{--  image  --}}
                        <div class="form-floating mb-3">
                            <input type="file" name="app_icon" class="form-control image">
{{--                            <input type="hidden" id="app_icon" name="app_icon" class="form-control image">--}}
{{--                            <img src="" id="app_icon_display" width="50" height="50" style="display: none">--}}
...
{{--                            <input type="hidden" id="splash_screen" name="splash_screen" class="form-control splash_screen">--}}
{{--                            <img src="" id="splash_screen_display" width="50" height="50" style="display: none">--}}
...
{{--    splash screeb--}}
    <div class="modal fade" id="modal_splash_image" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel">Cropper.Js Cropper
