                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col text-center">
                            <span class="h4">{{ count($subscribers) }}</span>
                            <h6 class="text-uppercase text-muted mt-2 m-0">Total Subscriber</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="button-items">
                        <h5 class="page-title text-center mb-3"><strong>Subscribers Listing</strong></h5>
