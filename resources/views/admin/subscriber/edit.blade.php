            ...
            <div class="card">
                ...
                <div class="card-header border-0">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ URL::to('/admin/categories') }}" class="btn btn-soft-secondary float-right w-100"
                ...
                <div class="card-body">
                    <form class="form-parsley" action='{{ URL::to("/admin/categories/$category->id") }}' method="POST" enctype="multipart/form-data"
                        novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="title"
                                placeholder="enter title here" data-parsley-maxlength="200" value="{{ $category->title }}"
                                required>
                            <label for="floatingInput">Title</label>
                        </div>

                          {{--  image  --}}
                          <img src="{{ asset('storage/categories/'. $category->image) }}" width="30%" alt="Category Image">
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" placeholder="write seo_description" id="floatingTextarea1" name="seo_description"
                                style="height: 100px" data-parsley-maxlength="255">{{ $category->seo_description }}</textarea>
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" name="seo_abstraction"
                                style="height: 75px" data-parsley-maxlength="100">{{ $category->seo_abstraction }}</textarea>
                            <label for="floatingTextarea2">SEO Abstraction (max 03 keywords)</label>
                        </div>

                        {{-- seo_keywords --}}
                        <div class="form-floating mb-3">
                            <textarea class="form-control" placeholder="write seo_description" id="floatingTextarea3" name="seo_keywords"
                                style="height: 100px" data-parsley-maxlength="500">{{ $category->seo_keywords }}</textarea>
