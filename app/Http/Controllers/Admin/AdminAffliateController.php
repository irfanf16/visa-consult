...
class AdminAffliateController extends Controller
{
    use SlugGenerate;
    ...
    */
    public function index()
    {
        try {
            ...
            return view('admin.affliate.index')->with([
                'status' => 200,
                'banners' => $banners,
    ...
    */
    public function create()
    {
        try {
            ...
            return view('admin.affliate.create');
        } catch (\Throwable $th) {
            throw $th;
        }
    }
...
//                'featured' => $request->featured == "on" ? 1 : 0,
            ...
            if ($image = $request->file('image')) {
                $destinationPath = 'storage/affliate/';
            ...
            Affliate::create($formData);

            Session::flash('Alert', [
                'status' => 200,
                'message' => 'Affliate is added successfully.'
            ]);
    ...
    */
    ...
    public function destroy($id)
    {
        ...
        Affliate::findorfail($id)->delete();

        Session::flash('Alert', [
            'status' => 200,
            'message' => 'Affliate is deleted successfully.'
        ]);
        return back();
    }
